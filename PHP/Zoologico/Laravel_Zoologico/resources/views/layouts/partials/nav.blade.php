    ...
    <div class="container mx-auto flex px-8 xl:px-0">
        ...
        <div id="menu" class="hidden flex-grow w-full justify-between items-center absolute top-40 left-0 bg-green-800 py-14 px-8 lg:flex lg:relative lg:top-0 lg:py-0 lg:px-0 sm:px-14">
            ...
            <div class="flex flex-col text-center lg:flex-row">
                <a href="#" class="text-lg font-semibold text-green-800 bg-white py-1 px-4 rounded-lg shadow-lg mb-4 lg:mb-0 lg:mr-4 transition duration-300 ease-in-out hover:bg-green-700 hover:text-white hover:shadow-xl">
                    Iniciar Sesión
                </a>
                <a href="#" class="text-lg font-semibold text-white bg-green-600 py-1 px-4 rounded-lg shadow-lg transition duration-300 ease-in-out hover:bg-green-500 hover:shadow-xl">
                    Regístrate
                </a>
            </div>
        </div>
