...
<form action="{{ route('animales.store') }}" method="POST" enctype="multipart/form-data" class="mt-8 p-8 bg-gray-100 shadow-lg rounded-lg max-w-3xl mx-auto">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="especie" id="especie" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
    </div>


    <div class="mb-4">
        <label for="peso" class="block text-lg font-semibold text-gray-700">Peso (kg)</label>
        <input type="number" name="peso" id="peso"  class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" >
    </div>


    <div class="mb-4">
        <label for="altura" class="block text-lg font-semibold text-gray-700">Altura (cm)</label>
        <input type="number" name="altura" id="altura"  class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" >
    </div>


    <div class="mb-4">
        <label for="fechaNacimiento" class="block text-lg font-semibold text-gray-700">Fecha de Nacimiento</label>
        <input type="date" name="fechaNacimiento" id="fechaNacimiento"  class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="alimentacion" id="alimentacion"  class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
    </div>


    <div class="mb-4">
        <label for="descripcion" class="block text-lg font-semibold text-gray-700">Descripción</label>
        <textarea name="descripcion" id="descripcion" rows="4" class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" ></textarea>
    </div>
